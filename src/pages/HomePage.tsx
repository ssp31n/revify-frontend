...
const HomePage = () => {
  return (
    // w-full로 전체를 감싸고 내부에서 max-w 제한하여 컨텐츠 집중
    <div className="w-full flex-1 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-background relative overflow-hidden">
      {/* Background Decor */}
